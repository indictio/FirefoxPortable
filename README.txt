Instructiuni pentru instalarea aplicatiei Firefox Portable prin care se acceseaza aplicatiile Oracle
----------------------------------------------------------------------------------------------------
...
- Este posibil sa apara un popup cu "Allow apps.euro.ro to run Java?" - dati click pe butonul "Allow and Remember". Daca ati dat doar pe "Allow Now" din repezeala, nu-i nimic, sa aveti grija sa dati pe "Allow and Remember" data viitoare.
- Este posibil sa mai apara un popup cu titlul "Warning - Security" - bifati "Always trust content from this publisher" si apoi dati click pe butonul Run.
